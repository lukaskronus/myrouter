...
# Clone source code
git clone --single-branch --filter=blob:none -b v21.02.7 https://github.com/openwrt/openwrt openwrt_release
git clone --single-branch --filter=blob:none -b openwrt-21.02 https://github.com/openwrt/openwrt openwrt
...
rm -f ./openwrt/include/kernel-5.4
...
cp -f ./openwrt_release/include/kernel-5.4 ./openwrt/include/kernel-5.4
...
# Vermagic
wget https://downloads.openwrt.org/releases/21.02.7/targets/ramips/mt7621/packages/Packages.gz
