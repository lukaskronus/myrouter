...
git clone --single-branch --filter=blob:none -b v24.10.1 https://github.com/immortalwrt/immortalwrt.git openwrt_release
git clone --single-branch --filter=blob:none -b openwrt-24.10 https://github.com/immortalwrt/immortalwrt.git openwrt
