...
git clone --single-branch --filter=blob:none -b v22.03.7 https://github.com/openwrt/openwrt.git openwrt_release
git clone --single-branch --filter=blob:none -b openwrt-22.03 https://github.com/openwrt/openwrt.git openwrt
